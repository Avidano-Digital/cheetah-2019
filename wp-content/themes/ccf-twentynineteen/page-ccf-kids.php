    ...
    <section class="bg-info cheetah-spots">
        ...
        <div class="container" id="kids-tabs">
            ...
            <nav class="nav nav-pills flex-column flex-md-row" role="tablist">
                <a class="nav-item nav-link flex-even" id="" href="/kids/cheetah-facts" aria-selected="false" role="tab">
                    Cheetah Facts
                </a>

                <a class="nav-item nav-link flex-even active" id="" href="/kids/ccf-kids" aria-selected="true" role="tab">
                    CCF Kids
                </a>
            </nav>
